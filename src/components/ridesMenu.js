          ...
          <div className="search-options">
            <div>
              ...
              <DropdownButton bsStyle="default" title={this.state.sItem} id="show-dropdown">
                <MenuItem eventKey="active-rides" onClick={() => this.setState({sItem: "Active rides"})} className={(this.state.sItem === "Active rides") ? "active" : ""}>Active Rides</MenuItem>
                <MenuItem eventKey="finished-rides" onClick={() => this.setState({sItem: "Finished rides"})} className={(this.state.sItem === "Finished rides") ? "active" : ""}>Finished Rides</MenuItem>
                <MenuItem eventKey="canceled-rides" onClick={() => this.setState({sItem: "Canceled rides"})} className={(this.state.sItem === "Canceled rides") ? "active" : ""}>Canceled Rides</MenuItem>
                <MenuItem eventKey="all-rides" onClick={() => this.setState({sItem: "All rides"})} className={(this.state.sItem === "All rides") ? "active" : ""}>All Rides</MenuItem>
              </DropdownButton>
            </div>
            <div>
              <FormControl id="rides-search-box" type="text" label="Text" placeholder="Search by client or driver name" className="input-search-box"/>
